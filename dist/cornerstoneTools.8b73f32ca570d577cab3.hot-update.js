...
/* harmony default export */ __webpack_exports__["default"] = (function (context, textLines, x, y, color) {
  ...
  var boundingBox = {
    width: maxWidth,
    height: padding + textLines.length * (fontSize + padding) + 6
  };
  Object(_draw_js__WEBPACK_IMPORTED_MODULE_1__["default"])(context, function (context) {
    ...
    boundingBox.left = x + 10;
    boundingBox.top = y + 10; // Check if a displacer function was provided
...
//# sourceMappingURL=cornerstoneTools.8b73f32ca570d577cab3.hot-update.js.map